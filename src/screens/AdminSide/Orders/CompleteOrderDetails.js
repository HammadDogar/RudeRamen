...
const CompletedOrderDetails = ({navigation, route}) => {
      ...
      <View style={{flex: 1}}>
        ...
        <ScrollView contentContainerStyle={{}}>
          ...
          <View
            ...
            <View flexDirection="row" marginTop={10} justifyContent="flex-end">
              <Text
                style={{
                  fontSize: 26,
                  marginRight: 10,
          ...
          <View
            ...
            <Text
              ...
              Order Status: {orderDetailsState?.orderStatusName || ''}
            </Text>
          </View>
        </ScrollView>
      </View>
